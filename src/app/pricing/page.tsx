...
export const metadata: Metadata = {
  title: "Pricing — Testdaf Premium",
  description: "Unlock unlimited Testdaf practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=testdaf&cadence=annual`;
