...
const EXAM_ID = "testdaf";
const EXAM_DISPLAY_NAME = "TestDaF (Test Deutsch als Fremdsprache)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Antworte auf Deutsch (Niveau B2–C1).

Decke alle vier Fertigkeiten ab: Leseverstehen, Hörverstehen, Schriftlicher Ausdruck und Mündlicher Ausdruck. Erkläre die TDN-Bewertungskriterien und typische Aufgabenformate.
